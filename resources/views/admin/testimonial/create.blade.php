...
@section('admin')
    <div class="page-content">
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">Testimonial Section</div>
                <div class="ps-3">
            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-custom-header">
                        <h6 class="mb-0 text-uppercase">Create Testimonial</h6>
                    </div>
                    <hr />
                                ...
                                <div class="col-md-12 mb-2">
                                    <div class="form-group">
                                        <label for="" class="form-label">Testimony</label>
                                          <textarea type="text" class="form-control" name="testimony">{{ old('testimony') }}</textarea>
                                        @error('testimony')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
