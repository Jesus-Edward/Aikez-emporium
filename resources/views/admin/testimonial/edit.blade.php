                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="location" value="{{ $testimonial->location }}">
                                        @error('location')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-12 mb-2">
                                    <div class="form-group">
                                        <label for="" class="form-label">Testimony</label>
                                          <textarea type="text" class="form-control" name="testimony">{{ $testimonial->testimony }}</textarea>
                                        @error('testimony')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <div class="mt-2">
                                        <img src="{{ asset($testimonial->image) }}" id="showImage" class="" width="80">
                                    </div>
                                </div>
