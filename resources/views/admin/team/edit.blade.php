                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="member_role" value="{{ $team->member_role }}">
                                        @error('member_role')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 mb-2">
                                    <div class="form-group">
                                        <label for="" class="form-label">Gmail Address</label>
                                          <input type="text" class="form-control" name="gmail" value="{{ $team->gmail }}">
                                        @error('gmail')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <div class="mt-2">
                                        <img src="{{ asset($team->image) }}" id="showImage" class="" width="80">
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="selectric-wrapper selectric-form-control">
                                                <select name="status" id="" class="form-control selectric">
                                                    <option value="1" @selected($team->status === 1)>Active</option>
                                                    <option value="0" @selected($team->status === 0)>Inactive</option>
                                                </select>
                                            </div>
                                            @error('status')
                                                <small class="text-danger">{{ $message }}</small>
