            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-custom-header">
                        <h6 class="mb-0 text-uppercase">Update About</h6>
                    </div>
                    <hr />
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.about.update', $about->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-2">
                                    <div class="form-group">
                                        <label for="" class="form-label">About Status</label>
                                ...
                                <div class="col-md-12 mb-2">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" class="form-control" name="about_description">
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <div class="mt-2">
                                        <img src="{{ asset($about->about_image) }}" id="showImage" class="" width="80">
                                    </div>
                                </div>
