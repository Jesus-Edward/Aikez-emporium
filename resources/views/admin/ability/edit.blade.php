        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.ability.update', $ability->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="selectric-wrapper selectric-form-control">
                                                <select name="status" id="" class="form-control selectric">
                                                    <option value="1" @selected($ability->status === 1)>Active</option>
                                                    <option value="0" @selected($ability->status === 0)>Inactive</option>
                                                </select>
                                            </div>
                                            @error('status')
                                                <small class="text-danger">{{ $message }}</small>
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <div class="mt-2">
                                        <img src="{{ asset($ability->image) }}" id="showImage" class="" width="80">
                                    </div>
                                </div>
                            </div>
