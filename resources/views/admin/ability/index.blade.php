                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 mb-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="statistic_title"
                                                                class="form-control" value="{{ $stat->title }}">
                                                    ...
                                                    <div class="col-md-6 mb-2">
                                                        <div class="form-group">
                                                            <label for="" class="form-label">Statistic
                                                                Ability</label>
                                                            <input type="text" name="statistic_ability"
                                                                class="form-control" value="{{ $stat->value }}">
                                                    ...
                                                    <div class="col-md-6 mb-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="statistic_title1"
                                                                class="form-control" value="{{ $stat->title1 }}">
                                                    ...
                                                    <div class="col-md-6 mb-2">
                                                        <div class="form-group">
                                                            <label for="" class="form-label">Statistic
                                                                Ability 1</label>
                                                            <input type="text" name="statistic_ability1"
                                                                class="form-control" value="{{ $stat->value1 }}">
                                                    ...
                                                    <div class="col-md-6 mb-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="statistic_title2"
                                                                class="form-control" value="{{ $stat->title2 }}">
                                                    ...
                                                    <div class="col-md-6 mb-2">
                                                        <div class="form-group">
                                                            <label for="" class="form-label">Statistic
                                                                Ability 2</label>
                                                            <input type="text" name="statistic_ability2"
                                                                class="form-control" value="{{ $stat->value1 }}">
