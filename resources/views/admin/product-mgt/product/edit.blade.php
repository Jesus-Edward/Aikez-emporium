                        ...
                        <form action="{{ route('admin.product.update', $product->id) }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <div class="mt-2">
                                        <img src="{{ asset($product->image) }}" id="showImage" class=""
                                            width="80">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <div class="mt-2">
                                        <img src="{{ asset($product->image2) }}" id="showImage2" class=""
                                            width="80">
                                    </div>
                                </div>
                                <div class="col-md-6 mb-2">
                                    ...
                                    <div class="mt-2">
                                        <img src="{{ asset($product->image3) }}" id="showImage3" class=""
                                            width="80">
                                    </div>
                                </div>
                                <div class="col-md-6 mb-2">
                                    ...
                                    <div class="mt-2">
                                        <img src="{{ asset($product->image4) }}" id="showImage4" class=""
                                            width="80">
                                    </div>
                                </div>
